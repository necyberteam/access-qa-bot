...
type FlowPath = string | ((chatState: ChatState) => string);
 ...
 */
export function createAccessLoginFlow({ ticketForm: _ticketForm, setTicketForm, userInfo }: FlowParams): Flow {
  ...
  return {
    ...
    access_login_description: {
      ...
      chatDisabled: false, // Enable text input for description
